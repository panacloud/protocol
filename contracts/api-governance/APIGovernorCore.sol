...
contract APIGovernorCore {
    ...
    uint public proposalThresholdPercent;
    
    // @notice The Percentage of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    uint public quorumVotesPercent;
    ...
    modifier onlyAdmin() {
        require(admin == msg.sender, "API Governor: caller is not the Admin");
        _;
    }
