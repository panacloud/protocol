...
contract PanacloudController is Ownable  {
    ...
    function initialize(address _panacoin, address _apiIdeaNFT, address _panacloudPlatform, address _panaGoverner, address _panaFactory, address _timelock) public onlyOwner {
        ...
        panaFactory.initialize(_panacoin, _apiIdeaNFT,_panacloudPlatform);
