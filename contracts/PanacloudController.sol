...
import "./APINFT.sol";
import "./governance/PlatformGoverner.sol";
...
contract PanacloudController is Ownable  {
    ...
    function initialize(address _panacoin, address _apiIdeaNFT, address _panacloudPlatform, 
                        address _panaGoverner, address _panaFactory, address _timelock, 
        ...
        panacloudGoverner.initialize(_timelock, _panacoin, 1, 17280, 10000000e18);
